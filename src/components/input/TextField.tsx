  ...
  return (
    <AnimatePresence>
      <div className="flex w-full flex-col space-y-[6px]">
        ...
        <div
          className={twMerge(
            'relative flex h-12 w-full flex-row items-center rounded-lg border transition-all hover:border-slate-900',
        ...
        >
          <input
            ...
            className={twMerge(
              'h-full w-full rounded-lg px-4 py-3 text-slate-900 placeholder:text-slate-400 disabled:text-slate-500'
            )}
          />
          {isSuccess && (
